...
if GetLocale() == "ruRU" then
   ...
   L["SLASH_CMD_REBUILD"] = "/oa rebuild - принудительно перестроить кэш сканера достижений."
   L["SLASH_CMD_DEBUG"] = "/oa debug - переключить режим отладки (показ ID в подсказках)."
    
   L["SCANNER_INIT_MSG"] = "Сканер инициализирован через %s. (%.2f мс)"
   L["SCANNER_REBUILT"] = "Кэш сканера достижений перестроен."
    
   L["OPT_DEBUG_TITLE"] = "Показывать ID в подсказках (режим отладки)"
   L["OPT_DEBUG_DESC"] = "Отображает ID НИП, предметов и достижений во всплывающих подсказках."
