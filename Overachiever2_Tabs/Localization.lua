...
if GetLocale() == "ruRU" then
   L["TAB_WATCH"] = "Отслеживание"
   L["TAB_WATCH_DESC"] = "Добавляйте любимые достижения в личный список отслеживания.\nНажмите Alt+ЛКМ на любом достижении, чтобы добавить его."
   L["TAB_WATCH_SORT_BY"] = "Сортировка:"

   L["TAB_WATCH_REMOVE_ACHIEVEMENT"] = "Удалить достижение из списка отслеживания. Также его можно удалить, щелкнув по нему ПКМ."
end
